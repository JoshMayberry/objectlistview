...
class ObjectListView(wx.dataview.DataViewCtrl):
    ...
    * ownerDrawn
    ...
    def InReportView(self):
        return True #There is only a report view right now
    ...
    def SetImageList(self, *args, **kwargs):
        print("@2.1", args, kwargs)
    ...
    def ClearAll(self):
        ...
        """
        print("@2.2")
        # wx.dataview.DataViewCtrl.ClearAll(self)
    ...
    def DeleteAllItems(self):
        ...
        Remove all items
        """
        wx.dataview.DataViewCtrl.DeleteAllItems(self)
        self.SetObjects(list())
    ...
    def HitTestSubItem(self, pt):
        ...
        if wx.Platform == "__WXMSW__":
            return wx.dataview.DataViewCtrl.HitTestSubItem(self, pt)
...
class AbstractVirtualObjectListView(ObjectListView):
    ...
    def SetItemCount(self, count):
        ...
        ObjectListView.SetItemCount(self, count)
    ...
    def OnGetItemAttr(self, itemIdx):
        ...
        # process it.
        self.listItemAttr = wx.dataview.DataViewItemAttr()
        self._FormatOneItem(
            self.listItemAttr,
            itemIdx,
    ...
    * putBlankLineBetweenGroups
    ...
    def _DoExpandCollapse(self, groups, isExpanding):
        ...
        for group in evt.groups:
            ...
            #     print("@1", index, realIndex, x, y, length, height)
            #     if (y < height):
        ...
        # print("@2", self.GetItemRect(self.GetTopItem(), wx.LIST_RECT_BOUNDS))
        # print("@3", self.GetItemRect(self.GetTopItem(), wx.LIST_RECT_LABEL))
        ...
        # print("@1.2", self.GetScrollPos(wx.VERTICAL), self.GetScrollRange(wx.VERTICAL), len(self.innerList))
